...
- `codex-briefing.md` — stock plugin (rescue + setup are model-invokable; review/adversarial are user-only). Describe the *stock* surface here, not the fork's — fork-only facts belong in the extended briefing.
